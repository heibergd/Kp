<?php 
    ...
    if ($_SESSION["tipo"] != 0) {
        GestorConfigController::verficar_usuario("newUser");
    }
    ...
    <div
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__body kt-portlet__body--fit p-2">
                <!--begin::Form-->
                <form class="kt-form" id="formNuevoUsuario">
                    ...
                    <div class="kt-portlet__foot">
                        <div class="kt-form__actions">
                            <button class="btn btn-primary" id="crearUsuario">CREATE</button>
