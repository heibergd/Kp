            ...
            <div class="kt-portlet__body kt-portlet__body--fit p-2">
                                    ...
                                    foreach ($mainFixtures as $fixture) {
                                            ...
                                            if ($db_fixture && $valid){
                                                if ($fixture['tipo'] == 0 && is_numeric($db_fixture['quantity'])) {
                                                    ...
                                                    $total = $fixture['precio_cobrar'] * $db_fixture['quantity'];
                                                }else{
                                                    $total_main_quantity += 1;
                                                    $total = $fixture['precio_cobrar'];
                                                }
                                        ...
                                        ?>   
                                            <tr>
                                                ...
                                                <td>$<?php echo number_format($fixture['precio_cobrar'], 2) ?></td>
                ...
                <div class="kt-portlet__foot">
                    <div class="kt-form__actions">
                        <form action="views/modules/downPdfSheetBill.php" method="post" target="_blank">
