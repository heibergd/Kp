<?php 
    ...
    if ($_SESSION["tipo"] != 0) {
        GestorConfigController::verficar_usuario("subdivisions");
    }  
   
    $q = isset($_SESSION["filtrarSubdivisions"]) ? $_SESSION["filtrarSubdivisions"] : "";
?>
        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                    ...
                    <form class="kt-margin-l-20" id="kt_subheader_search_form">
                        <div
                            ...
                            <span
                                ...
                                <span class="cursor" id="filtrarSubs" data-toggle="kt-tooltip" title="Search" data-placement="top">
                                    <svg
                    ...
                    <?php if ($q != "") { ?>
                        <span class="kt-input-icon__icon kt-input-icon__icon--right mright removeFilterSubs cursor" data-toggle="kt-tooltip" title="Remove Filter" data-placement="top">
            ...
            <div class="kt-subheader__toolbar">
                <a href="#" class="btn btn-label-brand btn-bold addSubdivision">
                    Add Subdivision
                </a>   
            </div>
        </div>
    ...
    <div
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__body kt-portlet__body--fit">
                <!--begin: Datatable -->
                <div class="kt-datatable" id="kt_apps_subdivisions_list_datatable">
                </div>
                <!--end: Datatable -->
            </div>
        </div>
