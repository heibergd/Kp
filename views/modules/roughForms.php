<?php 
    ...
    $q = isset($_SESSION["filtroRoughForm"]) ? $_SESSION["filtroRoughForm"] : "";
        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                    ...
                    <form class="kt-margin-l-20" id="kt_subheader_search_form">
                        <div
                            ...
                            <span
                                ...
                                <span class="cursor" id="filtrarRoughForms" data-toggle="kt-tooltip" title="Search" data-placement="top">
                                    <svg
                    ...
                    <?php if ($q != "") { ?>
                        <span class="kt-input-icon__icon kt-input-icon__icon--right mright removeFilterRoughForm cursor" data-toggle="kt-tooltip" title="Remove Filter" data-placement="top">
    ...
    <div
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__body kt-portlet__body--fit">
                <!--begin: Datatable -->
                <div class="kt-datatable" id="kt_apps_rough_forms_list_datatable">
                </div>
                <!--end: Datatable -->
            </div>
        </div>
