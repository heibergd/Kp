<?php 
    ...
    $q = isset($_SESSION["filtrarAcivitys"]) ? $_SESSION["filtrarAcivitys"] : "";
        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                    ...
                    <form class="kt-margin-l-20" id="kt_subheader_search_form">
                        <div
                            ...
                            <span
                                ...
                                <span class="cursor" id="filtrarActivities" data-toggle="kt-tooltip" title="Search" data-placement="top">
                                    <svg
                    ...
                    <?php if ($q != "") { ?>
                        <span class="kt-input-icon__icon kt-input-icon__icon--right mright removeFilterActivities cursor" data-toggle="kt-tooltip" title="Remove filter" data-placement="top">
                           ...
                           <div
                            class="kt-input-icon kt-input-icon--right kt-subheader__search">
                            <input style="margin-left:15px;" class="form-control" placeholder="term..." type="text" id="generalSearch2">
                    </div>
                    <?php } ?>
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="#" class="btn btn-label-brand btn-bold addActivity">
                    Add Activity
                </a>
                </a>
    ...
    >
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__body kt-portlet__body--fit">
                <!--begin: Datatable -->
                <div class="kt-datatable" id="kt_apps_activities_list_datatable">
                </div>
                <!--end: Datatable -->
            </div>
        </div>
