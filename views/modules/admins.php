<?php 
    ...
    if ($_SESSION["tipo"] != 0) {
        GestorConfigController::verficar_usuario("admins");
    } 
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
                    ...
                    <form class="kt-margin-l-20" id="kt_subheader_search_form">
                        <div
                            ...
                            <span
                                ...
                                <span class="cursor" id="filtrarUsers" data-toggle="kt-tooltip" title="Search" data-placement="top">
                                    <svg
                            ...
                            <?php if ($q != "") { ?>
                                <span class="kt-input-icon__icon kt-input-icon__icon--right mright removeFilter cursor" data-toggle="kt-tooltip" title="remove filters" data-placement="top">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="addAdmin" class="btn btn-label-brand btn-bold">
                    Add admin
                </a>
