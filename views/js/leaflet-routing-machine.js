...
(function() {
	...
	module.exports = L.Class.extend({
		...
		buildRouteUrl: function(waypoints, options) {
            ...
            locs.join(';') + '?access_token=' + __tkoen;
			...
			// 	(options.allowUTurns ? '&continue_straight=' + !options.allowUTurns : '')  + '?access_token=' + __tkoen;
		},
	...
	module.exports = (L.Layer || L.Class).extend({
		...
		options: {
			...
			createMarker: function(i, wp) {
                ...
                console.log(i)
                var abc = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", "P", "Q","R", "S"]
