...
// $.ajax({
//     url:"views/ajax/jsonConstructoras.php",
//     type: "POST",
//     dataType: "JSON"
// })
// .done((res)=>{
...
var KTUserListDatatable = (function() {
    ...
    return {
        init: function() {
            (t = $("#kt_apps_constructoras_list_datatable").KTDatatable({
                data: {
                    type: "remote",
                    source: {
                        read: {
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                        <li class="kt-nav__item">
                                            <a href="#" class="kt-nav__link edit_constructora" data-id="${t.id}"> 
                            ...
                            swal
                                ...
                                .then(function(t) {
                                    if (t.value) {
                                        ...
                                        var datos = {
                                            borrar_lista_constructoras: true,
                                            lista: e.toArray()
                                        }

                                        ajax.peticion("normal",datos,"views/ajax/gestorConstructora.php")
                                            .then((res)=>{                                                
                                                console.log(res)
                                                if (res.status == "ok") {
                                                    swal.fire({
                ...
                t.on("kt-datatable--on-layout-updated", function() {
                    ...
                    $(".borrarWorker").unbind().bind("click",function(e){
                        ...
                        swal.fire({
                                buttonsStyling: !1,
                                text:
                                    "Do you want to delete this builder?",
                                type: "info",
                                confirmButtonText: "Yes, delete!",
                                confirmButtonClass:
                                    "btn btn-sm btn-bold btn-danger",
                    ...
                    $(".edit_constructora").unbind().bind("click",function(e){
                        e.preventDefault()
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            dataType: "JSON",
                            data: {info_constructora: true, id: id}
                        })
                        .done((res)=>{
                            console.log(res);
                            ...
                            $("#formEditBuilder .nombre").val(res.nombre)
                            $("#formEditBuilder .id").val(id)

                            $("#edit_builder").modal("show")
                        })
                        .fail((fail)=>{
                            console.log(fail);
                        })
